...
export default class Register extends Component {
    ...
    addItem = ()=>{
        if(this.state.aac==this.state.valueeee){
            var asdasdd = document.getElementsByClassName('asdasdd')
            asdasdd[0].style.display="none"
            ...
            else if(this.state.aac!=this.state.valueeee){
                var asdasdd = document.getElementsByClassName('asdasdd')
    ...
    render(){
        ...
        const sendCode = async () =>{
            if(this.state.valueee==""){
                var asdasd = document.getElementsByClassName('asdasd')
                    ...
                    <WingBlank>
                        <div className="register_content">
                            ...
                            <div>
                                ...
                                onBlur={()=>{this.jugdeblankpwd(this.state.valueeee)}}

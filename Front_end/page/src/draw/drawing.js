...
export default function Drawing(props) {
    ...
    //     //qq空间接口的传参
    //     if(stype=='qzone'){
    //         window.open('https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url='+document.location.href+'?sharesource=qzone&title='+'标题'+'&pics='+lk+'&summary='+"描述");
    //     }
    //     //新浪微博接口的传参
    //     if(stype=='sina'){
    ...
    //     //qq好友接口的传参
    //     if(stype == 'qq'){
    //         window.open('http://connect.qq.com/widget/shareqq/index.html?url='+document.location.href+'?sharesource=qzone&title='+ftit+'&pics='+lk+'&summary=123');
    //     }
    ...
    return (
        <div className="drawing">
            ...
            <div className='drawing_bottom_no1' id="share" style={{ display: win ? 'none' : 'block' }}>
                {/* <button onClick={Preservation}>保存</button> */}
                {/* <button onClick={()=>(shareTo('qzone'))}>分享到qq空间</button> */}
                {/* <button onClick={()=>(shareTo('qq'))}>分享到qq好友</button>
                <button onClick={()=>(shareTo('sina'))}>分享到微博</button> */}
            </div> 

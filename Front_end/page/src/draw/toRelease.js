            ...
            <div className="drawing">
                ...
                <div className="drawing_canvas_div1_no1">
                    <div className="drawing_canvas_div1">
                        <canvas id="canvas" width={aa} height={aa}>
                            您的浏览器版本过低
                        </canvas>
                    </div>
                </div>
                ...
                <div className='drawing_bottom_no1' style={{ display: win ? 'none' : 'block' }} 
                onClick={per}>发 布</div>
                ...
                <div className="torelease" style={{display:jugdetor?"block":"none"}}>
                    ...
                    <div>
                        <button className="torelease_false_but_no1" 
                        onClick={choosetrue} onClick={perput}>确定</button>
                        <button className="torelease_false_but_no2" 
                        onClick={choosefalse}>返回</button>
                    </div>
                </div> 
                <div className="denglu_shadow" 
                style={{display:jugdetor?"block":"none"}}></div>

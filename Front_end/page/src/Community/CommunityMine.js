...
export default function CommunityMine() {
    ...
    return (
        <div >
            ...
            {
                data.map((item, idx) =>
                    <div className="community_chat_mine" style={{ display: flag== false ? "none" : "block" }}>
                        ...
                        <div className='community_chat_mine_talk'>
                            ...
                            <p className='community_chat_mine_time'>{timestampToTime(item.paintid.slice(item.paintid.length-13))}</p>
                        </div>
                    </div>
                )
            }

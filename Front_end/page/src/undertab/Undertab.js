		...
		return (
			<div className='Undertab_div'>
				<header>
					<div>
						<Link to='/database'>
							<div style={{color:this.props.flag=="1"?"rgb(233, 128, 42)":"black"}} 
						...
						<Link to='/community'>
							<div style={{color:this.props.flag=="2"?"rgb(233, 128, 42)":"black"}} 
						...
						<Link to='/torelease'>
							<div style={{color:this.props.flag=="3"?"rgb(233, 128, 42)":"black"}} 
						...
						<Link to='/shop'>
							<div style={{color:this.props.flag=="4"?"rgb(233, 128, 42)":"black"}} 
						...
						<Link to='/mine'>
							<div style={{color:this.props.flag=="5"?"rgb(233, 128, 42)":"black"}} 

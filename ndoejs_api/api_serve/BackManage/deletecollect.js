...
router.get('/',(req,res)=>{
    ...
    let deletesql = 'delete from collections_table where userid="'+userName+'" and paintid="'+paintName+'"';
    let selectsql = 'select * from collections_table where userid ="'+userName+'" and paintid="'+paintName+'"';
